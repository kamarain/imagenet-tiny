...
RUNNAME="ImageNet-tiny-8x8-sRGB" # network/solver should not affect
RUNCOUNT="" # -1, -2 etc if RUNNAME is the same
TEMPWORK=./TEMPWORK
TINYDIR=/home/kamarain/Data/ImageNet-tiny-8x8-sRGB-8bit
SOLVERTEMPLATE="solvers/imagenet-tiny-solver-1" # adds .prototxt.tmpl
NETWORKTEMPLATE="networks/net-4" # adds .prototxt.tmpl
RESUMEITER="140000" # for resume_training (check TEMPWORK dir)
...
NETFILE=`basename $NETWORKTEMPLATE`
SNAPSHOTPREFIX="$TEMPWORK/caffe_${RUNNAME}${RUNCOUNT}-${NETFILE}"
