...
RUNNAME="ImageNet-tiny-8x8-sRGB-8bit-convType-2-net-2" # network/solver should not affect
RUNCOUNT="" # -1, -2 etc if RUNNAME is the same
TEMPWORK=./TEMPWORK
TINYDIR=/sgn-data/Public/ImageNet-tiny/ImageNet-tiny-8x8-sRGB-8bit-convType-2
