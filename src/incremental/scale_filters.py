...
"""
scale_filters.py
It is used to the network with scaled filters.
-- liuyuan
"""
...
for pr_tiny, pr_large in zip(layers_tiny, layers_large):
    if params_large[pr_large][1].shape[3] == params_tiny[pr_tiny][1].shape[3]: # check the bias dimension
        params_large[pr_large][1][...] = params_tiny[pr_tiny][1] # copy bias from tiny to large
    else:
